...
$Foswiki::cfg{Http}{StrictTransportSecurity} = "max-age=31536000";
...
$Foswiki::cfg{Http}{ContentSecurityPolicy}{"script-src"} = "'self' disqus.com *.disqus.com *.disquscdn.com *.googleapis.com cdn.tinymce.com *.stripe.com connect.facebook.net 'unsafe-eval' 'unsafe-inline' blob:";

# **STRING CHECK="undefok emptyok"**
# Defines valid sources of stylesheets.
$Foswiki::cfg{Http}{ContentSecurityPolicy}{"style-src"} = "'self' disqus.com *.disqus.com *.disquscdn.com fonts.googleapis.com cdn.tinymce.com *.stripe.com 'unsafe-inline'";
...
$Foswiki::cfg{Http}{ContentSecurityPolicy}{"font-src"} = "'self' fonts.gstatic.com cdn.tinymce.com ";
...
$Foswiki::cfg{Http}{ContentSecurityPolicy}{"child-src"} = "blob: *";
